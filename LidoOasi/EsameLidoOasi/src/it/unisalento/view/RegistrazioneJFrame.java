...
public class RegistrazioneJFrame extends JFrame 
{
	...
	public JButton esci = new JButton("Torna al Login");
	...
	public RegistrazioneJFrame()
	{
		super("Finestra  di REGISTRAZIONE AL LIDO OASI");
	   ...
	   operatore.addActionListener(new AscoltatoreOperatoreNull(this));
	   conferma.addActionListener(new AscoltatoreConfermaRegistrazione(this));
	   esci.addActionListener(new AscoltatoreEsci(this));
	   bottoneVerifica.addActionListener(new AscoltatoreVerifica(this));
