...
/**
 * Registrazione Cliente  da Operatore
 * ci accedono il bagnino e l'amministratore
 * da JFrameBagnino e JFrameAmminisratore rispettivamente
 * @author Gio
 *
 */
public class RegistrazioneOpJFrame extends JFrame 
{
	...
	public JLabel etich7 = new JLabel("Email");
	...
	public RegistrazioneOpJFrame()
	{
		super("Finestra  di REGISTRAZIONE AL LIDO OASI da operatore");
	  ...
	  // operatore.addActionListener(new AscoltatoreOperatoreAttivo(this));
	   conferma.addActionListener(new AscoltatoreConfermaRegistrazioneOp(this));
	   prosegui.addActionListener(new AscoltatoreProsegui(this));
	   bottoneVerifica.addActionListener(new AscoltatoreVerificaOp(this));
